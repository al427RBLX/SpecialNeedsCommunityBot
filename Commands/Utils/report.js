...
module.exports = {
    ...
    async execute(msg, args, cmd, client, Discord) {
        ...
        const channel = await msg.guild.channels.create(`report: ${msg.author.tag}`);
        ...
        .setTitle('Special Needs Community Bot Contacting Report System')
        .setDescription('Thanks for contacting Special Needs Community report, a staff member will get back to you as soon as possible.')
        .setColor("BLACK")
